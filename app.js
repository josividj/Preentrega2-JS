...
while (i < arrayAlumnos.length) {
    arrayAlumnos.forEach((participante) => {
        console.log(participante.nombre);
        console.log(participante.numeroElegido);
        alert(participante.nombre + ' Ud. ha ingresado el número : ' + participante.numeroElegido); 
        numero = participante.numeroElegido;
